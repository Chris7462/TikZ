...
\begin{itemize}
  ...
  \item arrow: 
    ...
    \verb <-> ~\begin{tikzpicture} \filldraw[white] (0,0) rectangle (1em,1.5ex); \draw[<->] (0,0.7ex) -- (1em,0.7ex);\end{tikzpicture},
    \verb <<->> ~\begin{tikzpicture} \filldraw[white] (0,0) rectangle (1em,1.5ex); \draw[<<->>] (0,0.7ex) -- (1em,0.7ex);\end{tikzpicture},
    \verb >=stealth ~\begin{tikzpicture} \filldraw[white] (0,0) rectangle (1em,1.5ex); \draw[->>,>=stealth] (0,0.7ex) -- (1em,0.7ex);\end{tikzpicture}.
\end{itemize}
\noindent Note: \verb [help ~\verb lines]=[gray,very ~\verb thin] . Line thickness can be also specified by `line width' option, say \verb [line ~\verb width=0.5cm] .
