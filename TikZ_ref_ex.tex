...
\begin{itemize}
  ...
  \item thickness: 
    ultra thin \tikz \draw[ultra thin] (0,0) -- (1em,0);, 
    very thin \tikz \draw[very thin] (0,0) -- (1em,0);, 
    thin \tikz \draw[thin] (0,0) -- (1em,0);, 
    semithick \tikz \draw[semithick] (0,0) -- (1em,0);, 
    thick \tikz \draw[thick] (0,0) -- (1em,0);, 
    very thick \tikz \draw[very thick] (0,0) -- (1em,0);, 
    ultra thick \tikz \draw[ultra thick] (0,0) -- (1em,0);.
  \item line type: 
    loosely dashed \tikz \draw[loosely dashed] (0,0) -- (0.5,0);,
    dashed \tikz \draw[dashed] (0,0) -- (0.5,0);,
    densely dashed \tikz \draw[densely dashed] (0,0) -- (0.5,0);,
    loosely dotted \tikz \draw[loosely dotted] (0,0) -- (0.5,0);,
    dotted \tikz \draw[dotted] (0,0) -- (0.5,0);,
    densely dotted \tikz \draw[densely dotted] (0,0) -- (0.5,0);.
\end{itemize}
...
\begin{tikzpicture}
  \draw[red, very thin, densely dashed] (0,0) -- (0.9,0);
  \draw[blue, ultra thick, loosely dotted] (1.1,0) -- (1.9,0);
  \draw[green, semithick] (2.1,0) -- (2.9,0);
\end{tikzpicture}
